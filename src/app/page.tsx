...
export default function Home() {
  ...
  return (
    <main className="min-h-screen p-8 max-w-7xl mx-auto space-y-12 text-slate-200 relative overflow-x-hidden">
      ...
      <header className="space-y-4 relative z-10">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <h1 className="text-7xl font-black tracking-tighter glow-text italic leading-none uppercase">
              Comp Intelligence <span className="text-primary underline decoration-accent decoration-4 underline-offset-8 italic">v2.0</span>
            </h1>
            <p className="text-slate-500 text-xs font-mono uppercase tracking-[0.2em] mt-6 flex items-center gap-4">
          ...
          <div className="flex flex-col items-end gap-4">
            <button 
              ...
              className="bg-primary/10 border border-primary/20 text-primary px-8 py-3 rounded-2xl font-black text-xs tracking-widest hover:bg-primary/20 transition-all active:scale-95"
            >
              + CONTRIBUTE DATA
            </button>
            <div className="hidden lg:block glass p-4 border-primary/10 rounded-xl">
               <div className="text-[10px] font-mono text-primary/40 uppercase mb-2 tracking-widest">System Status</div>
               <div className="text-[9px] font-mono text-success space-y-1">
