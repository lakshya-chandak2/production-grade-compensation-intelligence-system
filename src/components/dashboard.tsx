    ...
    <div className="relative">
      {selected.length > 0 && (
        <motion.div 
          ...
          animate={{ opacity: 1, y: 0 }}
          className="fixed bottom-12 left-1/2 -translate-x-1/2 z-50 glass px-10 py-5 rounded-full flex items-center gap-8 border-primary glow-blue"
        >
          ...
          <button 
            ...
            className="px-8 py-2 bg-primary disabled:bg-slate-800 disabled:text-slate-600 text-black rounded-full font-black text-xs tracking-widest transition-all flex items-center gap-2 hover:scale-105 active:scale-95"
          >
